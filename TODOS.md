...
## v0.40.6.0 Schema Cathedral v3 follow-ups (v0.40.7+)

These were filed when v0.40.6.0 closed PR #1321's design as a production
...
- [ ] **v0.40.7+: enrichment-service.ts union widening (`'person' | 'company'` → `string`).**
  ...
  find_experts MCP already wired in v0.40.6.0).
...
- [ ] **v0.41+: T21 — comment-preserving YAML emitter.**
  v0.40.6.0 emitter does NOT preserve comments. Authors who care
