# Migrating your OpenClaw brain to gbrain v0.42.0.0 (greenfield)

The v0.42.0.0 lens packs ship a one-shot importer that re-ingests your
...
1. **Upgrade gbrain to v0.42.0.0+:**
   ```bash
   gbrain upgrade
   gbrain --version  # should be 0.42.0.0 or later
   ```
